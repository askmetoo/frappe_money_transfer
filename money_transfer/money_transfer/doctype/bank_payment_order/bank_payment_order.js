...
function check_payment_type(frm) {
	...
	if (payment_type == 1 || payment_type == 2) {
		...
		frm.set_df_property('sender_name', 'hidden', 1);
		frm.set_df_property('sender_region', 'hidden', 1);
		...
		frm.set_df_property('sender_name', 'hidden', 0);
		frm.set_df_property('sender_region', 'hidden', 0);
	}
}
...
function verification_on_click(frm) {
	...
	if (payment_method == 1 || payment_method == 2) {
		...
		verification_call(client_no, payment_method, frm);
	}
	else {
		var missed_fields = show_missed_fields(frm, ['card_type', 'card_no', 'sender_name', 'sender_region'])
		if (missed_fields) return;
		frm.save().then(() => {
...
function disable_verification_fields(frm) {
	frm.set_df_property("sender_bank", 'read_only', 1);
	frm.set_df_property("amount", 'read_only', 1);
	frm.set_df_property("currency", 'read_only', 1);
	frm.set_df_property("receiver_bank", 'read_only', 1);
	frm.set_df_property("account_type", 'read_only', 1);
	frm.set_df_property("beneficiary_no", 'read_only', 1);
	frm.set_df_property("card_no", 'read_only', 1);
	frm.set_df_property("card_type", 'read_only', 1);
	frm.set_df_property("sender_name", 'read_only', 1);
	frm.set_df_property("sender_region", 'read_only', 1);
	frm.set_df_property("branch", 'read_only', 1);
	frm.set_df_property("type", 'read_only', 1);
}

function disable_client_info_fields(frm) {
	frm.set_df_property("sender_bank", 'read_only', 1);
	frm.set_df_property("client_no", 'read_only', 1);
	frm.set_df_property("client_seril", 'read_only', 1);
	frm.set_df_property("branch", 'read_only', 1);
	frm.set_df_property("currency", 'read_only', 1);
}
function enable_client_info_fields(frm) {
	frm.set_df_property("sender_bank", 'read_only', 0);
	frm.set_df_property("client_no", 'read_only', 0);
	frm.set_df_property("client_seril", 'read_only', 0);
	frm.set_df_property("branch", 'read_only', 0);
...
function push_payment_on_click(frm) {
	...
	if (payment_method == 1 || payment_method == 2) {
		...
		sender_region = frm.doc.sender_region;
	}
	frappe.call({
